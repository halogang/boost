...
import { ProductProduct } from './columns';
...
export default function Edit({ product, uoms }: Props) {
  ...
  function submit(e: React.FormEvent) {
    ...
    form.put(`/products/${product.id}`, {
      ...
      onError: (errors) => {
        const errorMessage = errors.message || 'Gagal memperbarui produk. Periksa kembali data yang diinput.';
    ...
    <AdminLayout title="Edit Produk">
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
          <PageHeader
            title="Edit Produk"
            description="Edit informasi produk"
          />
        </div>
