...
export default function Edit({ uom, categories }: Props) {
  ...
  function submit(e: React.FormEvent) {
    e.preventDefault();
    form.put(`/uoms/${uom.id}`, {
      onSuccess: () => {
        success('Berhasil', 'UOM berhasil diperbarui');
        router.visit('/uoms');
      },
      onError: (errors) => {
        const errorMessage = errors.message || 'Gagal memperbarui UOM. Periksa kembali data yang diinput.';
